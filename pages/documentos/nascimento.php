          ...
          <div class="modal-content">
              <div class="modal-header">
                  ...
                  <div class="modal-body">
                    <form action="docnascimento.php" method="POST">
                      ...
                      <div class="form-group">
                       ...
                       <input type="number" class="form-control" id="modal-confirma" name="codigo">
                       </div>
              ...
              <?php
                ...
                <div class="card-body">
                  ...
                  <hr class="mt-4">
                    ...
                    <button class="btn btn-primary container p-5" data-bs-toggle="modal" data-bs-target="#confirma-modal" data-bs-whatever="NASCIMENTO"><img src="../../images/babystroller_86198 (1).png">NASCIMENTO</button>
            ...
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                 ...
                 <a href="segundavia.php"><button class="btn btn-primary  container p-5" data-bs-toggle="modal" data-bs-target="#segreg-modal"><img src="../../images/babystroller_86198 (1).png">NASCIMENTO</button></a>
