        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="charts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="#">Criar usuários</a></li>
        ...
        <div class="content-wrapper">
          <div class="row" id="formRegisto">
            <div class="col-lg-12">
              ...
              ?>
              <form action="../../php/cadastroUsuario.php" method="POST" name="formuser">
                  ...
                  <div class="form-group float-lg-end mt-2">
                    <label for="Cadastrar"></label>
                      ...
                      <button id="Cadastrar" name="Cadastrar" class="btn btn-success" type="Submit" onclick="return validar()">REGISTAR</button>
