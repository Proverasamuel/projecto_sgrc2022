      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="welcome-text text-black">Área Administrativa</h1>
            <h3 class="welcome-sub-text">Serviços da Conservatória</h3>
          </li>
        </ul>
        ...
        <ul class="nav">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" data-bs-toggle="collapse" aria-expanded="false" aria-controls="ui-basic" href="#ui-basic" ><span>Certidão de Casamento</span><i class="menu-arrow"></i></a>
                  <ul class="collapse" id="ui-basic" style="list-style-type: none;">
                    <li class="nav-item"> <a class="nav-link" href="../ui-features/dropdowns.html">Cadastrar</a></li>
                    <li class="nav-item"> <a class="nav-link" href="#">Listar</a></li>
                      </ul>
                ...
                <li class="nav-item"> <a class="nav-link" data-bs-toggle="collapse" aria-expanded="false" aria-controls="ui-basic" href="#ui-basic" ><span>Certidão de Obito</span> <i class="menu-arrow"></i> </a>
                  <ul class="collapse" id="ui-basic" style="list-style-type: none;">
                    <li class="nav-item"> <a class="nav-link" href="../ui-features/registroobi.php">Cadastrar</a></li>
                    <li class="nav-item"> <a class="nav-link" href="#">Listar</a></li>
                      </ul>
                </li>
              </ul>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="charts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="../usuarios/usuario.php">Criar usuários</a></li>
                <li class="nav-item"> <a class="nav-link" href="../usuarios/conservatoria.php">Cadastrar conservatória</a></li>
              </ul>
            </div>
          </li>
      ...
      <div class="main-panel" id="asspos">
        <div class="content-wrapper">
          <div class="row" id="formRegisto">
            <div class="col-lg-12">
              <h2 class="mt-4">Criar Usúario</h2>
              <?php
              ...
              ?>
              <form action="../../php/cadastroUsuarioedit.php" method="POST" name="formuser">
                  <h4 class="mt-4">Dados do usúario</h4>
                  <div class="form-group col-lg-10">
                    <input type="text" name="nomeFuncionario" id="nomeFuncionario" value="<?php echo $linha['nomeUsuario'];?>" class="form-control" required >
                    <label for="nomeFuncionario" id="lbl">Nome</label>
                  </div>
                  <div class="form-group col-lg-10">
                    <input type="email" name="email" id="email" value="<?php echo $linha['emailUsuario'];?>" class="form-control"required>
                    <label for="senha" id="lbl">E-mail</label>
                  </div>
                  <div class="form-group col-lg-10">
                  <select name="selectCargo" id="selectCargo" class="form-control" required>
                        <option value="<?php echo $linha['idCargo'];?>"><?php echo $linha['nomeCargo'];?></option>
                        <?php

                            $resultSelectcargo = "SELECT * FROM cargo";
                            $cargos = mysqli_query($conexao, $resultSelectcargo);
                            while ($rowCargos = mysqli_fetch_assoc($cargos)) {?>
                            <option value="<?php echo $rowCargos['idCargo'];?>"> <?php echo $rowCargos['nomeCargo'] ?></option><?php
                            }
                        ?>
                  </select>
                    <label for="cargo" id="lbl">Cargo</label>
                  </div>
                  <div class="form-group col-lg-10">
                  <select name="selectConservatoria" id="selectConservatoria" class="form-control" required>
                        <option value="<?php echo $linha['idConservatoria'];?>"><?php echo $linha['nomeConservatoria'];?></option>
                        <?php
                              $resultSelectconservatoria = "SELECT * FROM conservatoria";
                              $conservatorias = mysqli_query($conexao, $resultSelectconservatoria);
                              while ($rowConservatorias = mysqli_fetch_assoc($conservatorias)) {?>
                              <option value="<?php echo $rowConservatorias['idConservatoria'];?>"> <?php echo $rowConservatorias['nomeConservatoria'] ?></option><?php
                              }
                        ?>
                  </select>
                    <label for="conservatória" id="lbl">Conservatória</label>
                  </div>
                  <div class="form-group col-lg-10">
                    <input type="password" name="senha" id="senha" value="<?php echo $linha['senha']?>" class="form-control" required>
                    <label for="senha" id="lbl">Senha</label>
                  </div>
                  <div class="form-group col-lg-10">
                    <input type="password" name="confSenha" id="confSenha" value="<?php echo $linha['confSenha']?>" class="form-control" required>
                    <label for="confSenha" id="lbl">Confirmação de senha</label>
                  </div>
                  <div class="form-group float-lg-end mt-2">
                    <label for="Cadastrar"></label>
                    
                      <button id="Cadastrar" name="Cadastrar" class="btn btn-success" type="Submit" onclick="return validar()">SALVAR</button>
                      <button id="Cancelar" name="Cancelar" class="btn btn-danger" type="Reset">CANCELAR</button>
                      <input type="hidden" name="id" value="<?php echo $linha['idUsuario'];?>">
                  </div>
                </form>
                </div>
            </div>
