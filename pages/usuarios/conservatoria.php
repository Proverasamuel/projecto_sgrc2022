        ...
        <div class="content-wrapper">
          <div class="row" id="formRegisto">
            <div class="col-lg-12">
              ...
              ?>
              <form action="../../php/cadastroConservatoria.php" method="POST">
                  <h4 class="mt-4">Dados da conservatória</h4>
                  <div class="form-group col-lg-10">
                    <input type="text" name="nomeConservatoria" id="nomeConservatoria" class="form-control" >
           ...
           <!--        <span class="carregando">Aguarde, carregando...</span> -->
                ...
                <div class="form-group col-lg-10">
                    <input type="text" name="nomeBairro" id="nomeBairro" class="form-control" >
