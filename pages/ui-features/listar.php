  ...
  <div class="container-scroller">
    <!-- partial:../../partials/_ -->
     <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        ...
        <div>
          <a class="navbar-brand brand-logo" href="../../conservador.php">
    ...
    <div class="container-fluid page-body-wrapper">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="" onclick="refresh">Listar</a></li>
                  </ul>
                </li>
      ...
      <?php
        ...
        $sql = "SELECT registando.nomeProprio,registando.idRegistando,registando.status,registando.nomeFamilia,registando.nRegisto, pai.nomeP, mae.nome FROM registando JOIN pai ON registando.idRegistando=pai.idRegistando JOIN mae ON pai.idPai=mae.idPai JOIN usuario on registando.idUsuario=usuario.idUsuario  WHERE nomeProprio LIKE '%$pesquisa%' ORDER BY $idUser";
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                          <div class="card-body">
                            <h4 class="card-title">Processos por deferir</h4>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      ...
                                      <a href='listarnasc.php?id=$idRegistando' class='btn btn-primary btn-sm'>Ver</a>
                                          <a href='deferir.php?id=$idRegistando' class='btn btn-success btn-sm'>Deferir</a>
                                      </td>
                                  </tr>";
                                    }
                                  ?>
