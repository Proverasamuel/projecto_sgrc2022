      ...
      <div class="main-panel" id="asspos" >
        <div class="content-wrapper">
                <div class="row" id="formRegisto">
                  ...
                  include_once("../../php/conexao.php");
                  $id=$_GET['id'] ?? '';
                  $sqlBuscaobi="SELECT * FROM boletimobi WHERE boletimobi.idObito = $id";
                $dadosObito=mysqli_query($conexao,$sqlBuscaobi);
                $linha = @mysqli_fetch_assoc($dadosObito);                  
                  ?>
                  <div class="col-lg-12">
                    <h2 class="mt-4">Rectificação de registo de Obito</h2>
                    <?php
                        if (isset($_SESSION['m'])) {
                          echo $_SESSION['m'];
                          unset($_SESSION['m']);
                    ...
                    ?>
                    <form action="../../php/cadastroobitoedit.php" method="POST">
                        <h4 class="mt-4">FALECIDO</h4>
                        <div class="form-group col-lg-10">
                          <input type="text" name="assento" id="assento" class="form-control"value="<?php echo $linha['nAssento'];?>" readonly>
                          <label for="assento" id="lbl">Número de assento</label>
                        </div>
                        <div class="form-group col-lg-10">
                          <input type="text" name="localMorte" id="localMorte" class="form-control" value="<?php echo $linha['localMorte'];?>">
                          <label for="localMorte" id="lbl">Local da morte</label>
                        </div>
                        <div class="form-group col-lg-10">
                          <label for="hora_morte" id="lbl">Hora da Morte</label>
                          <input type="time" name="horaMorte" id="horaMorte" class="form-control" value="<?php echo $linha['horaMorte'];?>">
                        </div>
                        <div class="form-group col-lg-10">
                          <label for="dataMorte" id="lbl">Data da Morte</label>
                          <input type="date" name="dataMorte" id="dataMorte" class="form-control" value="<?php echo $linha['dataMorte'];?>">
                        </div>
                        <div class="form-group col-lg-10">
                        ...
                        <div class="form-group col-lg-10">
                          <input type="text" name="nomeDeclarante" id="nomeDeclarante" class="form-control"  value="<?php echo $linha['nomeDeclarante'];?>">
