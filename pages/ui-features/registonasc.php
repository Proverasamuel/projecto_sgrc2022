          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              <div class="dropdown-header text-center">
                ...
                <p class="mb-1 mt-3 font-weight-semibold"><?php echo $user  . '-' . utf8_encode($cargo); ?></p>
      ...
      <!-- partial -->
        ...
        <div class="content-wrapper">
          <div class="row" id="formRegisto">
            <div class="col-lg-12">
              <h2 class="mt-4">Registo de Nascimento</h2>
              <?php
              ...
              <form action="../../php/cadastroRegistando.php" method="POST" class="form">
                ...
                <div class="form-step form-step-active">
                  ...
                  <div class="form-group col-lg-10">
                    <input type="text" name="nomeProprio" id="nomeProprio" class="form-control" >
                    <label for="nomeProprio" id="lbl">Nome Proprio</label>
                  </div>
                  <div class="form-group col-lg-10">
                    <input type="text" name="nomeFamilia" id="nomeFamilia" class="form-control">
           ...
           <!--        <span class="carregando">Aguarde, carregando...</span> -->
                  ...
                  <div class="form-group " >
                    ...
                    <label  class="radio-inline" for="radios-0" >
                      <input name="sexo" id="sexo" value="Femenino" type="radio">
                      Femenino
                    </label> 
                  ...
                  <div class="form-group col-lg-10">
                    ...
                    <input type="number" name="nAssento" id="nAssento" value="<?php echo rand(1000,9999); ?>"class="form-control" readonly>
                  </div>
                  <div class="form-group col-lg-10">
                    <label for="horaNascimentp" id="lbl">Hora de Nascimento</label>
                    <input type="time" name="horaNascimento" id="horaNascimento" class="form-control">
                  </div>
                  <div class="form-group col-lg-10">
                    <label for="dataNascimento" id="lbl">Data de Nascimento</label>
                    <input type="date" max="2022-31-12" min="2008-31-12" name="dataNascimento" id="dataNascimento" class="form-control">
                  </div>
                  <div class="">
                ...
                <div class="form-step" >
                  ...
                  <div class="form-group col-lg-10"> 
                    <input id="nomePai" name="nomePai" class="form-control "  type="text">
                   ...
                   <div class="form-group col-lg-10">
                    ...
                    <div class="form-group col-lg-10">  
                      <input id="naturalidadePai" name="naturalidadePai"  class="form-control"  type="text">
                      <label for="Natural_de" id="lbl">Naturalidade</label>
                    </div>
                    <div class="form-group col-lg-10">  
                      <input id="residenciaPai" name="residenciaPai" class="form-control"  type="text">
                      <label for="residencia" id="lbl">Província de Residencia</label>
                    </div>
                    <div class="form-group col-lg-10">
                      <input id="municipioPai" name="municipioPai"  class="form-control"  type="text">
                      <label  for="municipioPai" id="lbl">Municipio </label>
                    </div>
                    <div class="form-group col-lg-10">  
                      <input id="comunaPai" name="comunaPai" class="form-control"  type="text">
                      <label for="comunaPai" id="lbl">Comuna<h11></h11></label>
                    </div>
                    <div class="form-group col-lg-10">  
                      <input id="nacionalidadePai" name="nacionalidadePai" class="form-control"  type="text">
                ...
                <div class="form-step ">
                  ...
                  <div class="form-group col-lg-10"> 
                    <input id="nomeMae" name="nomeMae"  class="form-control" type="text">
                  ...
                  <div class="form-group col-lg-10">
                    ...
                    <div class="form-group col-lg-10">  
                      <input id="naturalidadeMae" name="naturalidadeMae"  class="form-control"  type="text">
                      <label  for="Mae_natural_de" id="lbl">Naturalidade</label>
                    </div>
                    <div class="form-group col-lg-10">  
                      <input id="residenciaMae" name="residenciaMae" class="form-control"  type="text">
                      <label for="residencia" id="lbl">Província de Residencia</label>
                    </div>
                    <div class="form-group col-lg-10">
                      <input id="municipioPai" name="municipioMae"  class="form-control"  type="text">
                      <label  for="municipio_pai" id="lbl">Municipio </label>
                    </div>
                    <div class="form-group col-lg-10">  
                      <input id="comunaMae" name="comunaMae" class="form-control"  type="text">
                      <label for="comuna_pai" id="lbl">Comuna<h11></h11></label>
                    </div>
                    <div class="form-group col-lg-10">  
                      <input id="nacionalidadeMae" name="nacionalidadeMae" class="form-control"  type="text">
                ...
                <div class="form-step">
                  ...
                  <div class="form-group col-lg-10"> 
                    <input id="nomeavoP" name="avohomemPaterno"  class="form-control"  type="text">
                    <label  for="Nome_mae" id="lbl">Avo Paterno</label>  
                  </div>
                  <div class="form-group col-lg-10"> 
                    <input id="nomeavôP" name="avomulherPaterno"  class="form-control"  type="text">
                    <label  for="Nome_mae" id="lbl">Avô Paterno</label>  
                  </div>
                  <div class="form-group col-lg-10"> 
                    <input id="nomeavoM" name="avohomemMaterno"  class="form-control" type="text">
                    <label  for="Nome_mae" id="lbl">Avo Materno</label>  
                  </div>
                  <div class="form-group col-lg-10"> 
                    <input id="nomeavôM" name="avomulherMaterno"  class="form-control"  type="text">
                    <label  for="Nome_mae" id="lbl">Avô Materno</label>  
                  </div>
                  <div class="form-group col-lg-10"> 
                    <input id="declarante" name="declarante"  class="form-control"  type="text">
                   ...
                   <div class="form-group float-lg-end mt-2">
                      <label for="Cadastrar"></label>
                        ...
                        <input type="hidden" name="nomeFuncionario" value="<?php echo $user; ?>">
                        <input type="hidden" name="nUsuario" value="<?php echo $n_user; ?>">
                    </div>
                    <div class="">
                      <a  class="btn btn-prev btn-primary" href="#ti">Anterior</a>
                    </div>
