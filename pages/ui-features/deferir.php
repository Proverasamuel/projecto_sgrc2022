<?php
  ...
  if (isset ($_SESSION['emailUsuario']) && $_SESSION['idCargo']==2) {
    $email=$_SESSION['emailUsuario'];
    $user=$_SESSION['nomeUsuario'];
  }else {
    $_SESSION['loginErro'] = "Faça Login Conservador";
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" data-bs-toggle="collapse" aria-expanded="false" aria-controls="ui-basic" href="#ui-basic" ><span>Certidão de Obito</span> <i class="menu-arrow"></i> </a>
                  <ul class="collapse" id="ui-basic" style="list-style-type: none;">
                    <li class="nav-item"> <a class="nav-link" href="">Cadastrar</a></li>
                    <li class="nav-item"> <a class="nav-link" href="../../pages/ui-features/listar.php">Listar</a></li>
                      </ul>
                </li>
              </ul>
            </div>
        ...
        <div class="content-wrapper">
          <div class="row" id="formRegisto">
            ...
            <div class="col-lg-12">
              ...
              ?>  
              <form action="../../php/deferimento.php" method="POST" class="form">
                ...
                <div class="form-step form-step-active">
                  ...
                  <div class="form-group col-lg-10">
                    <input type="text" name="nomeProprio" id="nomeProprio" class="form-control" readonly value="<?php echo $linha['nomeProprio']; ?>">
                    <label for="nomeProprio" id="lbl">Nome Proprio</label>
                  </div>
                  <div class="form-group col-lg-10">
                    <input type="text" name="nomeFamilia" id="nomeFamilia" class="form-control" readonly value="<?php echo $linha['nomeFamilia']; ?>">
                    <label for="nomeFamilia" id="lbl">Nome de Familia</label>
                  </div>
                  <div class="form-group col-lg-10">
                  <select name="idProvincia" id="idProvincia" class="form-control" readonly>
                    <option readonly value="<?php echo $linhaMunicipio['idProvincia']; ?>"><?php echo $linhaMunicipio['nomeProvincia']; ?></option>
                    <?php
           ...
           <!--        <span class="carregando">Aguarde, carregando...</span> -->
                  <select name="idMunicipio" id="idMunicipio" class="form-control" readonly>
                    <option readonly value="<?php echo $linhaMunicipio['idMunicipio']; ?>"><?php echo $linhaMunicipio['nomeMunicipio']; ?></option>
                  </select>
                  ...
                  <div class="form-group " >
                    ...
                    <label  class="radio-inline" for="radios-0" >
                      <input name="sexo" id="sexo"  type="radio" readonly value="<?php echo $linha['genero']; ?>">
                      Feminino
                    </label> 
                  ...
                  <div class="form-group col-lg-10">
                    ...
                    <input type="number" name="nAssento" id="nAssento" readonly value="<?php echo $linha['nRegisto']; ?>" class="form-control">
                  </div>
                  <div class="form-group col-lg-10">
                    <label for="horaNascimentp" id="lbl">Hora de Nascimento</label>
                    <input type="time" name="horaNascimento" id="horaNascimento" class="form-control" readonly value="<?php echo $linha['dataRegisto']; ?>">
                  </div>
                  <div class="form-group col-lg-10">
                    <label for="dataNascimento" id="lbl">Data de Nascimento</label>
                    <input type="date"  name="dataNascimento" id="dataNascimento" class="form-control" readonly value="<?php echo $linha['dataNascimento']; ?>">
                  </div>
                  <div class="">
                ...
                <div class="form-step" >
                  ...
                  <div class="form-group col-lg-10"> 
                    <input id="nomePai" name="nomePai" class="form-control "  type="text" readonly value="<?php echo $linha['nomeP']; ?>">
                    <label for="nomePai" id="lbl">Nome do Pai</label> 
                   </div>
                   <div class="form-group col-lg-10">
                    <label for="Estado Civil Mãe" id="lbl">Estado Civil </label>
                
                    <select  id="estadocivilPai" name="estadocivilPai" class="form-control " readonly >
                    ...
                    <div class="form-group col-lg-10">  
                      <input id="naturalidadePai" name="naturalidadePai"  class="form-control"  type="text" readonly value="<?php echo $linha['naturalidadeP']; ?>">
                      <label for="Natural_de" id="lbl">Naturalidade</label>
                    </div>
                    <div class="form-group col-lg-10">  
                      <input id="residenciaPai" name="residenciaPai" class="form-control"  type="text" readonly value="<?php echo $linha['provinciaResP']; ?>">
                      <label for="residencia" id="lbl">Província de Residencia</label>
                    </div>
                    <div class="form-group col-lg-10">
                      <input id="municipioPai" name="municipioPai"  class="form-control"  type="text" readonly value="<?php echo $linha['municipioP']; ?>">
                      <label  for="municipioPai" id="lbl">Municipio </label>
                    </div>
                    <div class="form-group col-lg-10">  
                      <input id="comunaPai" name="comunaPai" class="form-control"  type="text" readonly value="<?php echo $linha['comunaP']; ?>">
                      <label for="comunaPai" id="lbl">Comuna<h11></h11></label>
                    </div>
                    <div class="form-group col-lg-10">  
                      <input id="nacionalidadePai" name="nacionalidadePai" class="form-control"  type="text" readonly value="<?php echo $linha['nacionalidadeP']; ?>">
                ...
                <div class="form-step ">
                  ...
                  <div class="form-group col-lg-10"> 
                    <input id="nomeMae" name="nomeMae"  class="form-control" type="text" readonly value="<?php echo $linha['nome']; ?>">
                    <label  for="Nome_mae" id="lbl">Nome da Mãe</label>  
                  </div>
                  <div class="form-group col-lg-10">
                    <label for="Estado Civil Mãe" id="lbl">Estado Civil</label>
                
                    <select id="estadoCivilmae" name="estadocivilMae" class="form-control" readonly>
                    ...
                    <div class="form-group col-lg-10">  
                      <input id="naturalidadeMae" name="naturalidadeMae"  class="form-control"  type="text" readonly value="<?php echo $linha['naturalidade']; ?>">
                      <label  for="Mae_natural_de" id="lbl">Naturalidade</label>
                    </div>
                    <div class="form-group col-lg-10">  
                      <input id="residenciaMae" name="residenciaMae" class="form-control"  type="text" readonly value="<?php echo $linha['provinciaRes']; ?>">
                      <label for="residencia" id="lbl">Província de Residencia</label>
                    </div>
                    <div class="form-group col-lg-10">
                      <input id="municipioPai" name="municipioMae"  class="form-control"  type="text" readonly value="<?php echo $linha['municipio']; ?>">
                      <label  for="municipio_pai" id="lbl">Municipio </label>
                    </div>
                    <div class="form-group col-lg-10">  
                      <input id="comunaMae" name="comunaMae" class="form-control"  type="text" readonly value="<?php echo $linha['comuna']; ?>">
                      <label for="comuna_pai" id="lbl">Comuna<h11></h11></label>
                    </div>
                    <div class="form-group col-lg-10">  
                      <input id="nacionalidadeMae" name="nacionalidadeMae" class="form-control" readonly type="text" value="<?php echo $linha['nacionalidade']; ?>">
                ...
                <div class="form-step">
                  ...
                  <div class="form-group col-lg-10"> 
                    <input id="nomeavoP" name="avohomemPaterno"  class="form-control"  type="text" readonly value="<?php echo $linha['avoPaterno']; ?>">
                    <label  for="Nome_mae" id="lbl">Avo Paterno</label>  
                  </div>
                  <div class="form-group col-lg-10"> 
                    <input id="nomeavôP" name="avomulherPaterno"  class="form-control"  type="text" readonly value="<?php echo $linha['avoPater']; ?>">
                    <label  for="Nome_mae" id="lbl">Avô Paterno</label>  
                  </div>
                  <div class="form-group col-lg-10"> 
                    <input id="nomeavoM" name="avohomemMaterno"  class="form-control" type="text" readonly value="<?php echo $linha['avoMaterna']; ?>">
                    <label  for="Nome_mae" id="lbl">Avo Materno</label>  
                  </div>
                  <div class="form-group col-lg-10"> 
                    <input id="nomeavôM" name="avomulherMaterno"  class="form-control"  type="text" readonly value="<?php echo $linha['avoMater']; ?>">
                    <label  for="Nome_mae" id="lbl">Avô Materno</label>  
                  </div>
                  <div class="form-group col-lg-10">
                    <textarea class="form-control"  rows="5" id="comment" name="mencoes" Required></textarea>
                    <label for="" id="lbl">Menções</label>
                            </div>
                   <div class="form-group float-lg-end mt-2">
                      <label for="Cadastrar"></label>
                      
                        <button id="Cadastrar" name="Cadastrar" class="btn btn-success" type="Submit">DEFERIR</button>
