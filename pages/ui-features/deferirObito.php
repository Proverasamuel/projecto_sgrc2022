  ...
  <div class="container-scroller">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="welcome-text text-black">Área Do Conservador</h1>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="../../conservador.php">
      ...
      <!-- partial -->
        ...
        include_once("../../php/conexao.php");
        $id=$_GET['id'] ?? '';
        $sqlO="SELECT boletimobi.idObito, boletimobi.nAssento, boletimobi.dataMorte, boletimobi.localMorte, boletimobi.horaMorte, boletimobi.nProcesso, boletimobi.nomeDeclarante 
        FROM boletimobi WHERE idObito=$id";
         $queryO=mysqli_query($conexao, $sqlO);
         $linha=mysqli_fetch_assoc($queryO);
        ...
        <div class="content-wrapper">
                <div class="row" id="formRegisto">
                  <div class="col-lg-12">
                    ...
                    <form action="../../php/deferimentoObi.php" method="POST">
                        <h4 class="mt-4">FALECIDO</h4>
                        <div class="form-group col-lg-10">
                          <input type="text" name="nAssento" id="nAssento" class="form-control" value="<?php echo $linha['nAssento']; ?>"readonly >
                          <label for="nAssento" id="lbl">Número de assento</label>
                        </div>
                        <div class="form-group col-lg-10">
                          <input type="text" name="localMorte" id="localMorte" class="form-control" value="<?php echo $linha['localMorte']; ?>"readonly>
                          <label for="localMorte" id="lbl">Local da morte</label>
                        </div>
                        <div class="form-group col-lg-10">
                          <label for="horaMorte" id="lbl">Hora da Morte</label>
                          <input type="time" name="horaMorte" id="horaMorte" class="form-control" value="<?php echo $linha['horaMorte']; ?>"readonly>
                        </div>
                        <div class="form-group col-lg-10">
                          <label for="dataMorte" id="lbl">Data da Morte</label>
                          <input type="date" name="dataMorte" id="dataMorte" class="form-control" value="<?php echo $linha['dataMorte']; ?>"readonly>
                        </div>
                        <div class="form-group col-lg-10">
                          <input type="text" name="nProcesso" id="nProcesso" class="form-control" value="<?php echo $linha['nProcesso']; ?>"readonly >
                          <label for="nProcesso" id="lbl">Número de Processo </label>
                        </div>
                        <div class="form-group col-lg-10">
                          <input type="text" name="nomeDeclarante" id="nomeDeclarante" class="form-control" value="<?php echo $linha['nomeDeclarante']; ?>"readonly >
                          <label for="nomeDeclarante" id="lbl">Declarante </label>
                        </div>

                        <div class="form-group float-lg-end mt-2">
                          <label for="Cadastrar"></label>
                          <input type="hidden" name="id" value="<?php echo $linha['idObito']; ?>">
