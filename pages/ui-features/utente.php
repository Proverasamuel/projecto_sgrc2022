...
$linha = mysqli_fetch_assoc($dados);
  ...
  $sqlBusca="SELECT registando.nomeProprio, registando.nomeFamilia FROM registando WHERE registando.idRegistando = $id";
  $nomeConservatoria="";
   ...
   use Dompdf\Dompdf;
    ...
    font-size: 10px;">
        ...
        <div class="body-element">
            ...
            <h5 style="margin-left: 1em;">Nome Completo: '.$linha['nomeProprio'].' '.$linha['nomeFamilia'].'</h5>
            <h5 style="margin-left: 1em;">Pai: '.$linha['nomeP'].'</h5>
            <h5 style="margin-left: 1em;">Mãe: '.$linha['nome'].'</h5>
 ...
 Passo 2.1: Caso quiser a primeira via insira este codigo <em style="color: darkblue;">'.'"'.$linha['nRegisto'].'"'.'</em> e verifique os seus dados e baixe o documento caso o status deferido.
