          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="../ui-features/listar.php">Listar</a></li>
                  </ul>
                </li>
                ...
                <li class="nav-item"> <a class="nav-link" data-bs-toggle="collapse" aria-expanded="false" aria-controls="ui-basic" href="#ui-basic" ><span>Certidão de Obito</span> <i class="menu-arrow"></i> </a>
                  <ul class="collapse" id="ui-basic" style="list-style-type: none;">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="pages/ui-features/listaobiConse.php">Listar</a></li>
                      </ul>
                </li>
              </ul>
            </div>
                                ...
                                <?php
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      ...
                                      <td width='150px'>
                                      <a href='listarobi.php?id=$idObito' class='btn btn-primary btn-sm'>Ver</a>
                                          <a href='deferirObito.php?id=$idObito' class='btn btn-success btn-sm'>Deferir</a>
                                      </td>
                                  </tr>";
                                    }
                                  ?>
