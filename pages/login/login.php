          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              <div class="brand-logo">
                <img src="../../images/SGRC.jpg" style="width: 18%;" alt="logo">
              </div>
              <h1 class="fw-light">Login</h1>
              <form class="pt-3" action="../../php/loginuser.php" method="post">
                ...
                <div class="mt-3">
                  <button id="Cadastrar" name="Cadastrar" class="btn btn-success" type="Submit">Login</button>
                </div>
