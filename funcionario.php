<?php
 ...
 $registos="SELECT * FROM `registando` WHERE idUsuario= $idUser";
 $registo= mysqli_query($conexao, $registos);
 $cnt= mysqli_num_rows($registo);
 $registoObito="SELECT * FROM `boletimobi` WHERE idFuncionario= $idUser";
    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          ...
          <h1 class="welcome-text text-black">Bem-vindo, <?php echo $user; ?></h1>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <hr class="mt-4">
                   ...
                   <h4>Registos de nascimento efetuados: <?php echo $cnt ?></h4>
                   <h4>Registos de óbitos efetuados: <?php echo $cntO ?></h4>
                </div>
              </div>
            </div>
