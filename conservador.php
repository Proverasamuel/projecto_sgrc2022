<?php
  ...
  $registos="SELECT * FROM `registando` WHERE status='Pendente'";
 $registo= mysqli_query($conexao, $registos);
 $cnt= mysqli_num_rows($registo);
 $registoObito="SELECT * FROM `boletimobi` WHERE status='Pendente'";
 $registoO= mysqli_query($conexao, $registoObito);
 $cntO= mysqli_num_rows($registoO);
 $conservatoria="SELECT conservatoria.nomeConservatoria FROM usuario 
 JOIN conservatoria ON usuario.idConservatoria=conservatoria.idConservatoria WHERE idUsuario= $idUser";
 $cons=mysqli_query($conexao,$conservatoria);
  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="" onclick="refresh">
              ...
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" data-bs-toggle="collapse" aria-expanded="false" aria-controls="ui-basic" href="#ui-basic" ><span>Certidão de Obito</span> <i class="menu-arrow"></i> </a>
                  <ul class="collapse" id="ui-basic" style="list-style-type: none;">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="pages/ui-features/listarobiConse.php">Listar</a></li>
                      </ul>
                </li>
              </ul>
            </div>
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"><img src="images/faces/user-shape_icon-icons.com_73346.png" alt="Profile image"> Informações do usuário</h4>
                  <hr class="mt-4">
                   <h4><?php echo $cargo .":" . " Nº " . $idUser ?> </h4>
                   <h4>Nome: <?php echo $user; ?></h4>
                   <h4>E-mail: <?php echo $email?> </h4>
                   <h4>Cargo: <?php echo $cargo ?></h4>
                   <h4>Conservatória: <?php echo $linha['nomeConservatoria'] ?></h4>
                   <h4>Processos de nascimento por deferir: <?php echo $cnt ?></h4>
                   <h4>Processos de óbitos por deferir: <?php echo $cntO ?></h4>
                </div>
              </div>
            </div>
